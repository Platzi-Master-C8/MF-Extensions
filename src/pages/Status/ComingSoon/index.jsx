...
import Logo from 'Components/atoms/LogoSign';
      ...
      <MainContent>
        <Container maxWidth="md">
          ...
          <Box display="flex" justifyContent="center">
            {timerComponents.length ? timerComponents : <React.Fragment>Times up!</React.Fragment>}
          </Box>
          ...
          <Container maxWidth="sm">
            <Box sx={{ textAlign: 'center', p: 4 }}>
              <FormControl variant="outlined" fullWidth>
                ...
                />
                <FormHelperText>
                  Well email you once our website is launched!
                </FormHelperText>
              </FormControl>
              <Divider sx={{ my: 4 }} />
